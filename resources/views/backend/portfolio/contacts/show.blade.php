                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="md:col-span-1">
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">بيانات المرسل</h3>

                            <div class="space-y-4">
                                <div>
                                    <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">الاسم</h4>
                                ...
                                <div>
                                    <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">تاريخ الاستلام</h4>
                                    ...
                                    <p class="mt-1">
                                        @if($contact->read)
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100">
                                                مقروء {{ $contact->read_at ? '(' . $contact->read_at->format('M d, Y H:i') . ')' : '' }}
                                            </span>
                                        @else
