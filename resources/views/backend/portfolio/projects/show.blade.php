                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="md:col-span-1">
                        ...
                        <div class="mt-6 space-y-4">
                            <div>
                                <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">الحالة</h4>
                                <div class="mt-1">
                                    @if($project->featured)
                            ...
                            <div>
                                <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">ترتيب العرض</h4>
                                <p class="mt-1 text-gray-900 dark:text-white">{{ $project->order }}</p>
                            </div>

                            <div>
                                <h4 class="text-sm font-medium text-gray-500 dark:text-gray-400">الروابط</h4>
                    ...
                    <div class="md:col-span-2">
                        <div class="space-y-6">
                            <div>
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">الملخص</h3>
                                <p class="mt-1 text-gray-600 dark:text-gray-300">{{ $project->summary }}</p>
                            </div>

                            <div>
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">الوصف</h3>
                            ...
                            <div>
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">تفاصيل المشروع</h3>
                                <dl class="mt-2 grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">الرابط المختصر</dt>
