...
@section('meta_description', $profile->bio ?? 'ملف أعمال هندسة معمارية')
...
@section('content')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="mt-4 text-lg text-gray-600 dark:text-gray-300" data-aos="fade-up" data-aos-delay="100">
                    المهارات الأساسية التي أعتمد عليها لتنفيذ المشاريع المعمارية باحترافية
                </p>
            </div>
    ...
    <section class="py-16 bg-gray-50 dark:bg-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="mt-4 text-lg text-gray-600 dark:text-gray-300" data-aos="fade-up" data-aos-delay="100">
                    أعمال مختارة في القطاعات السكنية والثقافية والتجارية
                </p>
            </div>
    ...
    <section class="py-16 bg-white dark:bg-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                ...
                <p class="mt-4 text-lg text-gray-600 dark:text-gray-300" data-aos="fade-up" data-aos-delay="100">
                    رحلة عملية في التصميم المعماري وإدارة المشاريع
                </p>
            </div>
    ...
    <section class="py-16 bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-700 dark:to-indigo-800 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl font-bold mb-6" data-aos="fade-up">هل تخطط لمشروع جديد؟</h2>
            <p class="text-lg mb-8 text-blue-50 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="100">
                دعنا نناقش موقع المشروع، المتطلبات، والميزانية لنحوّل فكرتك إلى تصور معماري متكامل.
            </p>
