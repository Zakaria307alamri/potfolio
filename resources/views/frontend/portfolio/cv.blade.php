...
@section('meta_description', 'السيرة الذاتية والخبرة المهنية.')
...
@section('content')
    ...
    <section class="bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-700 dark:to-indigo-800 text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl font-bold mb-4" data-aos="fade-up">السيرة الذاتية</h1>
            <p class="text-lg mb-6 text-blue-50 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="100">
                ملخص الخبرة المهنية والمؤهلات
            </p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @else
                <div class="text-center py-16">
                    ...
                    <h3 class="mt-2 text-lg font-medium text-gray-900 dark:text-white">السيرة الذاتية غير متاحة</h3>
                    <p class="mt-1 text-gray-500 dark:text-gray-400">لا يوجد ملف سيرة ذاتية مرفوع حاليًا.</p>
                </div>
            @endif
        </div>
    </section>
    ...
    <section class="py-16 bg-gray-50 dark:bg-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-6" data-aos="fade-up">هل ترغب بالتعاون؟</h2>
            <p class="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="100">
                يسعدني مناقشة كيفية المساهمة في مشروعك أو فريقك الهندسي.
            </p>
