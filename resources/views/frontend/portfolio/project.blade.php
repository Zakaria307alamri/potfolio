...
@section('content')
    ...
    <section class="py-16 bg-white dark:bg-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div data-aos="fade-left">
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-6 shadow-md">
                        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">تفاصيل المشروع</h2>

                        <div class="space-y-4">
                            <div>
                                <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">نوع المشروع</h3>
                                <p class="mt-1 text-gray-900 dark:text-white">هندسة معمارية وتصميم</p>
                            </div>

                            @if($project->github_link)
                                <div>
                                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">مرجع التصميم</h3>
                                    <p class="mt-1">
                            ...
                            @if($project->demo_link)
                                <div>
                                    <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">رابط عرض المشروع</h3>
                                    <p class="mt-1">
                            ...
                            <div>
                                <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">تاريخ الإضافة</h3>
            ...
            <div class="mt-12" data-aos="fade-up">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">نبذة عن المشروع</h2>
    ...
    <section class="py-16 bg-gray-50 dark:bg-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-8 text-center" data-aos="fade-up">استكشف المزيد من المشاريع</h2>
