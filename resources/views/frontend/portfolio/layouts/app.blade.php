...
<head>
    ...
    <meta name="description" content="@yield('meta_description', $profile->bio ?? 'ملف أعمال مهندس معماري')">
    ...
    <style>
        ...
        body {
            ...
            background:
                radial-gradient(circle at 85% 15%, rgba(139, 111, 71, 0.09), transparent 35%),
                radial-gradient(circle at 15% 85%, rgba(199, 174, 138, 0.12), transparent 42%),
                var(--arch-bg);
        }
        .btn-primary {
            @apply inline-flex items-center justify-center px-6 py-3 rounded-md text-base font-semibold text-white shadow-sm transition-colors;
            background-color: var(--arch-primary);
        }
        .btn-primary:hover { background-color: var(--arch-primary-dark); }
        .btn-default {
            @apply inline-flex items-center justify-center px-6 py-3 rounded-md text-base font-medium border transition-colors;
            border-color: #d7c8b2;
            color: #5f4c32;
            background-color: #fffaf2;
        }
        .btn-default:hover { background-color: #f8f0e3; }
    </style>
    @stack('styles')
...
<body class="antialiased text-gray-900 dark:bg-gray-900 dark:text-white">
        ...
        <header class="bg-white dark:bg-gray-800 shadow-sm sticky top-0 z-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:items-center sm:space-x-8 sm:space-x-reverse">
                    ...
                    <div class="flex items-center sm:hidden" x-data="{ mobileMenuOpen: false }">
                        <button type="button" @click="mobileMenuOpen = !mobileMenuOpen" class="inline-flex items-center justify-center p-2 rounded-md text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500" aria-controls="mobile-menu" aria-expanded="false">
                ...
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <div class="mb-4 md:mb-0">
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            &copy; {{ date('Y') }} {{ $profile->name ?? config('app.name') }}. جميع الحقوق محفوظة.
                        </p>
                    </div>
