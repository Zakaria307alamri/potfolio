...
@section('meta_description', 'استعرض المشاريع المعمارية في القطاعات السكنية والثقافية والتجارية.')
...
@section('content')
    ...
    <section class="bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-700 dark:to-indigo-800 text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl font-bold mb-4 text-white drop-shadow-sm" data-aos="fade-up">المشاريع</h1>
            <p class="text-lg mb-0 text-stone-100 max-w-2xl mx-auto drop-shadow-sm" data-aos="fade-up" data-aos-delay="100">
                مجموعة منتقاة من المشاريع المعمارية من الفكرة إلى التنفيذ
            </p>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <div class="flex space-x-2">
                                    @if($project->github_link)
                                            <a href="{{ $project->github_link }}" target="_blank" rel="noopener noreferrer" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300" aria-label="Design Reference">
                                    ...
                                    @if($project->demo_link)
                                            <a href="{{ $project->demo_link }}" target="_blank" rel="noopener noreferrer" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300" aria-label="Project Walkthrough">
                ...
                @empty
                    <div class="col-span-full text-center py-16">
                        ...
                        <h3 class="mt-2 text-lg font-medium text-gray-900 dark:text-white">لا توجد مشاريع حاليًا</h3>
                        <p class="mt-1 text-gray-500 dark:text-gray-400">يمكنك العودة لاحقًا للاطلاع على آخر الأعمال.</p>
                    </div>
                @endforelse
            </div>
        </div>
    ...
    <section class="py-16 bg-white dark:bg-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-6" data-aos="fade-up">هل لديك مشروع معماري جديد؟</h2>
            <p class="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-2xl mx-auto" data-aos="fade-up" data-aos-delay="100">
                متاح للتعاون في المشاريع السكنية والثقافية والتجارية عبر جميع مراحل التصميم.
            </p>
